...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "testglx@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "testglx API";

        private String description = "testglx API documentation";
